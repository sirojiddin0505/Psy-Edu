...
function DoimiyTestPage() {
  ...
  const AddTest = async (e) => {
    ...
    try {
      ...
      console.log(err);
      toast.error("Test qo'shishni imkoni bo'lmadi");
    }
  };
  const GetTest = async () => {
    try {
      const res = await axios.get(
        "https://testpsyedu.limsa.uz/tests/category-type?category=usual"
      );
            ...
            <tbody>
              {filteredTests?.map((test, i) => (
                <tr key={test.id} className="bg-gray-600  ">
                  <td className="text-white border-2 font-bold text-center border-gray-400 px-2 py-2">
                    {i + 1}
                  </td>
                  <td className="text-white font-[700] text-[14px] border-2 border-gray-400 w-[300px] px-2 py-2">
                    {test.text}
                  </td>
                  <td
                    className={`border-2 font-[600] text-[14px] text-center border-gray-400 px-2 py-2 ${
                  ...
                  <td className="text-white font-[600] text-[14px] border-2 border-gray-400 px-2 py-2 ">
                    {(() => {
                  ...
                  <td className="text-white font-[600] text-[14px] text-center border-2 border-gray-400 px-2 py-2">
              ...
              <form onSubmit={AddTest} className="flex flex-col gap-4">
                ...
                <div>
                  ...
                  <select
                    ...
                    className="w-full border border-gray-300 px-2 py-2 rounded-md focus:outline-none focus:ring-2 focus:ring-blue-500"
                  >
